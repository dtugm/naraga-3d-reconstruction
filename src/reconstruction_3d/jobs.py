...
PREFIX = "/v1/internal/reconstruction-3d"
CONTRACT_VERSION = "2.0.0"  # tests assert this matches contract/openapi.yaml
MODELS: list[str] = ["dream3d", "cascade_mesh"]
OUTPUT_FORMATS: list[str] = ["gltf", "3dtiles"]
